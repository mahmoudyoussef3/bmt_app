...
declare
  ...
  v_raw    boolean;
begin
  insert into probe values ('A1. ships with enforcement off',
    case when public.platform_enforcement_mode() = 'off' then 'OK'
         else 'BROKEN — ships ' || public.platform_enforcement_mode() end);
