...
void main() {
  group('FleetVehicleModel Tests', () {
    test('fromJson parses comma-separated image URLs into images list', () {
      ...
      expect(vehicle.imageUrl, 'https://example.com/img1.jpg,https://example.com/img2.jpg');
    ...
    test('toJson serializes images list back into comma-separated image_url', () {
      ...
      expect(json['image_url'], 'https://example.com/img1.jpg,https://example.com/img2.jpg');
    });
  });
}
