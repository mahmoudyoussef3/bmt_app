...
import 'package:bmt_app/apps/dashboard/features/platform_licensing/presentation/screens/platform_features_screen.dart';
    ...
    MaterialApp(
      ...
      home: Directionality(
        ...
        child: BlocProvider(
          ...
          child: const Scaffold(body: PlatformFeaturesScreen()),
        ),
      ),
    ),
  );
