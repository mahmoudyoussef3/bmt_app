...
import 'package:bmt_app/apps/dashboard/features/platform_licensing/presentation/screens/platform_audit_screen.dart';
    ...
    MaterialApp(
      ...
      home: Directionality(
        ...
        child: BlocProvider<PlatformLicensingCubit>.value(
          ...
          child: const Scaffold(body: PlatformAuditScreen()),
        ),
      ),
    ),
  );
...
void main() {
  group('PlatformAuditScreen layout', () {
  ...
  group('PlatformAuditScreen reads as decisions', () {
