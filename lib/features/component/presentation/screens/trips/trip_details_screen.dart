...
import 'package:bmt_app/features/component/presentation/widgets/trips/trip_cancellation_flow.dart';
import 'package:bmt_app/features/component/presentation/widgets/trips/trip_qr_card.dart';
import 'package:bmt_app/features/component/presentation/widgets/trips/trip_review_flow.dart';
...
class TripDetailsScreen extends StatelessWidget {
  ...
  TripData? _resolve(BuildContext context) {
    if (tripId != null) return tripById(tripId!);
    final args = ModalRoute.of(context)?.settings.arguments;
    if (args is Map) {
      final id = args['tripId']?.toString();
      if (id != null) return tripById(id);
    }
    return kMockTrips.first;
  }

  @override
  Widget build(BuildContext context) {
    final trip = _resolve(context);
    if (trip == null) {
      return Scaffold(
...
class _PaymentCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final scheme = Theme.of(context).colorScheme;
    final color = trip.paymentColor(scheme);
