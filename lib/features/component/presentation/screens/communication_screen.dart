...
class ChatMessage {
  ...
  final String? duration; // For voice message
  final bool isRead;
...
class Conversation {
  final String id;
  final String name;
  final String category; // 'Support', 'Driver', 'Group'
  ...
  final Map<String, String>? meta; // Extra details
...
class _CommunicationScreenState extends State<CommunicationScreen>
  ...
  void _initializeMockData() {
    _conversations = [
      Conversation(
        ...
        messages: [
          ChatMessage(id: 'd1', sender: 'other', senderName: 'Captain Ahmed', text: 'Good morning, Ahmed. I am on my way to the pickup point.', time: '8:20 AM'),
          ChatMessage(id: 'd2', sender: 'user', senderName: 'User', text: 'Great, thanks! Should I wait near the main gate?', time: '8:22 AM'),
          ChatMessage(id: 'd3', sender: 'other', senderName: 'Captain Ahmed', text: 'Yes, near Gate 2 under the blue banner.', time: '8:24 AM'),
          ChatMessage(id: 'd4', sender: 'other', senderName: 'Captain Ahmed', text: 'I have arrived at Banha Station stop. Gate 2.', time: '8:42 AM', isRead: false),
        ],
      ),
      Conversation(
        id: 'conv_group_banha',
        ...
        messages: [
          ChatMessage(id: 'g1', sender: 'other', senderName: 'Sara Kamel', text: 'AC is freezing cold today, can we adjust it?', time: 'Yesterday, 8:10 AM'),
          ChatMessage(id: 'g2', sender: 'other', senderName: 'Captain Ahmed', text: 'Sure, I will turn down the fan speed.', time: 'Yesterday, 8:12 AM'),
          ChatMessage(id: 'g3', sender: 'other', senderName: 'Hazem Refaat', text: 'Thanks Sara, was about to ask as well!', time: 'Yesterday, 8:15 AM'),
          ChatMessage(id: 'g4', sender: 'other', senderName: 'Sara Kamel', text: 'Is anyone late today? We are moving in 5 mins.', time: 'Yesterday, 8:35 AM'),
        ],
      ),
      Conversation(
        id: 'conv_support',
        ...
        messages: [
          ChatMessage(id: 's1', sender: 'user', senderName: 'User', text: 'I faced a problem with my seat reservation. Screen locked up during payment confirmation.', time: 'Monday, 10:15 AM'),
          ChatMessage(id: 's2', sender: 'other', senderName: 'Support Agent', text: 'Let me look into this transaction for you. One moment.', time: 'Monday, 10:20 AM'),
          ChatMessage(
            id: 's3', 
            sender: 'other', 
            senderName: 'Support Agent', 
            text: 'I have attached the invoice of your transaction. Please confirm the details.', 
      ...
      Conversation(
        ...
        messages: [
          ChatMessage(id: 'k1', sender: 'user', senderName: 'User', text: 'Hello Captain, did you find a black notebook left in seat 4?', time: '2 days ago'),
          ChatMessage(id: 'k2', sender: 'other', senderName: 'Captain Khaled', text: 'Let me double check the rear seats at the end of the line.', time: '2 days ago'),
          ChatMessage(
            id: 'k3',
            sender: 'other',
            senderName: 'Captain Khaled',
            text: 'Yes! I found it. I left it at the Banha Station lost & found office.',
            time: '2 days ago',
            type: 'image',
  ...
  void _selectConversation(Conversation conv) {
    setState(() {
      ...
      conv.unreadCount = 0; // Reset unread count
  ...
  void _sendMessage() {
    ...
    setState(() {
      _activeConversation!.messages.add(newMessage);
  ...
  void _simulateAgentReply() {
    ...
    Timer(const Duration(seconds: 2), () {
      ...
      if (_activeConversation!.category == 'Driver') {
        ...
        replyText = 'Thank you for reaching out. We have registered this ticket modification in our system.';
      } else {
      ...
      final replyMessage = ChatMessage(
        id: 'msg_${math.Random().nextInt(10000)}',
        sender: 'other',
        senderName: _activeConversation!.category == 'Group' ? 'Kareem Aly' : _activeConversation!.name.split(' ').first,
        text: replyText,
        time: timeStr,
      );

      setState(() {
        _activeConversation!.messages.add(replyMessage);
        _isTyping = false;
      });
  ...
  void _declineCall(bool simulateMissed) {
    ...
    if (simulateMissed) {
      ...
      if (idx != -1) {
        setState(() {
          _conversations[idx].messages.add(missedCallMessage);
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Missed call from $_callName', style: const TextStyle(fontWeight: FontWeight.bold)),
  ...
  PreferredSizeWidget? _buildAppBar(ColorScheme scheme) {
    if (_currentView == 1) {
      return AppBar(
        title: const Text('Chat Hub', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
        leading: IconButton(
        ...
        actions: [
          IconButton(
            icon: const Icon(Icons.ring_volume_rounded, color: Colors.greenAccent),
  ...
  Widget _buildNotificationAlerts(ColorScheme scheme) {
    return Container(
      ...
      child: Row(
        children: [
          const Icon(Icons.phone_missed_rounded, color: Colors.redAccent, size: 18),
          const SizedBox(width: 10),
          Expanded(
            child: Text(
                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: _getCategoryColor(chat.category, scheme).withAlpha(30),
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                  ...
                                  color: _getCategoryColor(chat.category, scheme),
                                ),
                              ),
                            ),
                            const SizedBox(width: 8),
                            Expanded(
                              child: Text(
                                ...
                                style: TextStyle(
                                  fontSize: 12,
                                  color: chat.unreadCount > 0 ? scheme.onSurface : Colors.grey,
                            ...
                            if (isMissed) ...[
                              ...
                              const Icon(Icons.phone_missed_rounded, size: 14, color: Colors.redAccent),
                            ]
                          ],
                        ),
                      ],
  ...
  Widget _buildSupportChat(ColorScheme scheme) {
    ...
    return Column(
      ...
      children: [
        ...
        // Chat message area
        Expanded(
          child: _buildMessagesList(scheme),
        ),
          ...
          Row(
            children: [
              Container(
                ...
                child: Icon(Icons.directions_bus_rounded, color: scheme.primary, size: 18),
              ),
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(route, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                    const SizedBox(height: 2),
                    Text('$vehicle • $rating', style: const TextStyle(fontSize: 10, color: Colors.grey)),
                  ],
                ),
              ),
              Container(
                ...
                child: Text(
                  eta,
                  style: TextStyle(fontSize: 10, fontWeight: FontWeight.w900, color: scheme.secondary),
                ),
              )
            ],
          ),
          ...
          Row(
            ...
            children: [
              _buildDriverQuickActionChip('📞 Call', () {
                _startOutgoingCall(_activeConversation!.name, 'Shuttle Driver', _activeConversation!.initials);
              }, scheme),
  ...
  Widget _buildDriverQuickActionChip(String label, VoidCallback onTap, ColorScheme scheme) {
            ...
            children: [
              Column(
                ...
                children: [
                  Text(route, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                  const SizedBox(height: 2),
                  Text('$count • $shuttle', style: const TextStyle(fontSize: 10, color: Colors.grey)),
                ],
              ),
              const Icon(Icons.people_alt_rounded, size: 20, color: Colors.teal),
            ],
          ),
          const SizedBox(height: 10),
            ...
            child: ListView(
              ...
              children: [
                ...
                Container(
                  ...
                  child: const Text('+8', style: TextStyle(fontSize: 9, fontWeight: FontWeight.bold)),
                ),
              ],
            ),
          )
    ...
    return Align(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: isUser ? null : Border.all(color: scheme.outline.withAlpha(45)),
        ),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
  ...
  Widget _buildMessageContent(ChatMessage msg, bool isUser, ColorScheme scheme) {
    if (msg.type == 'image') {
      return Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [scheme.surfaceContainerHighest, scheme.outline.withAlpha(80)],
                ),
              ),
              child: Stack(
                children: [
                  const Center(child: Icon(Icons.image_rounded, color: Colors.grey, size: 30)),
                  Positioned(
                    right: 8,
                    bottom: 8,
                    child: CircleAvatar(
                      ...
                      child: const Icon(Icons.download_rounded, color: Colors.white, size: 12),
                    ),
                  ),
                ],
              ),
          ...
          Text(
            ...
            style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: isUser ? scheme.onPrimary : scheme.onSurface),
          ),
          Text(
      ...
      return Row(
        children: [
          GestureDetector(
            ...
            child: CircleAvatar(
              radius: 14,
              backgroundColor: isUser ? scheme.onPrimary.withAlpha(40) : scheme.primary.withAlpha(30),
              child: Icon(
              ...
              children: [
                ...
                Row(
                  children: List.generate(15, (index) {
                    ...
                    final isPlayed = _voiceIsPlaying && (index / 15.0) < _voicePlayProgress;
                    return Container(
                      width: 3,
                      height: height,
                      ...
                      decoration: BoxDecoration(
                        color: isPlayed
                            ...
                            : (isUser ? Colors.white.withAlpha(80) : Colors.grey.withAlpha(80)),
                ...
                Text(
                  _voiceIsPlaying
                      ? _formatDuration((double.parse(msg.duration!.split(':').last) * _voicePlayProgress).toInt())
                      : msg.duration ?? '0:00',
                  style: TextStyle(fontSize: 9, color: isUser ? Colors.white.withAlpha(160) : Colors.grey),
                ),
              ],
            ),
          ),
  ...
  Widget _buildCallViews(ColorScheme scheme) {
    return Scaffold(
      backgroundColor: const Color(0xFF0F172A), // Premium dark blue-slate background
      body: SafeArea(
        child: Stack(
          children: [
                  ...
                  return Stack(
                    ...
                    children: List.generate(3, (index) {
                      ...
                      return Container(
                        ...
                        decoration: BoxDecoration(
                          shape: BoxShape.circle,
                          color: scheme.primary.withAlpha((255 * (1.0 - val) * 0.15).toInt()),
                          border: Border.all(
                            color: scheme.primary.withAlpha((255 * (1.0 - val) * 0.3).toInt()),
                            width: 1,
                          ),
                        ),
                      );
