...
import 'package:bmt_app/features/component/presentation/widgets/booking/vehicle_image_strip.dart';
...
class _VehicleDetailsScreenState extends State<VehicleDetailsScreen> {
  ...
  VehicleDetailData? _resolveVehicle(BuildContext context) {
    if (widget.vehicleId != null) {
      return vehicleById(widget.vehicleId!);
    }
    final args = ModalRoute.of(context)?.settings.arguments;
    if (args is Map) {
      final id = args['vehicleId']?.toString();
      if (id != null) return vehicleById(id);
    }
    return kVehicleCatalog.first;
  }

  @override
  Widget build(BuildContext context) {
    final vehicle = _resolveVehicle(context);
    if (vehicle == null) {
      return Scaffold(
