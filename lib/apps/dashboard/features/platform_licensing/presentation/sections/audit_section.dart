...
///
/// It shares the «الفوترة والسجل» destination with the invoice ledger: both are
/// append-only records of what the platform did, neither is a daily
/// destination, and pairing them took two rows out of the sidebar.
///
...
class AuditSection extends StatefulWidget {
  const AuditSection({super.key, required this.state, this.tabBar});
