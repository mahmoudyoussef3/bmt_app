...
const _kTemplates = [
  ...
  _Template(
    'Under investigation',
    'تم استلام البلاغ وهو قيد الفحص من الفريق المختص.',
  ),
  _Template(
    'Resolved',
  ...
  _Template(
    'Trip delay',
    'تأخر الرحلة ناتج عن ظروف خارجة عن إرادتنا. نعتذر عن الإزعاج.',
  ),
  _Template(
    'Needs info',
    'نحتاج معلومات إضافية لإتمام المعالجة. يرجى التواصل معنا.',
  ),
];
                          ...
                          Expanded(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                DetailField(
                                  label: 'تاريخ الإنشاء',
                                  value: '${ticket.createdAt.toLocal()}',
                                ),
                                if (ticket.customerContactedAt != null)
                                  DetailField(
                                    label: 'تاريخ التواصل',
                                    value:
                                        '${ticket.customerContactedAt!.toLocal()}',
                                  ),
                                ...
                                if (state.selectedTicketAttachments != null &&
                                    state
