...
List<DashboardWorkspaceField> _detailFields(
  ...
  final extraFields = switch (workspace.id) {
    'drivers' => const [
      DashboardWorkspaceField(label: 'رقم البطاقة', value: '٢٩٣٠١١٤٠١٢٣٤٥٦'),
      DashboardWorkspaceField(label: 'العنوان', value: 'بنها - القليوبية'),
      DashboardWorkspaceField(label: 'المركبة الحالية', value: 'أ ب ج ٤٥٦'),
      DashboardWorkspaceField(
        label: 'المسار الحالي',
        value: 'بنها - القرية الذكية',
      ),
      DashboardWorkspaceField(label: 'تاريخ التعيين', value: '١٥ مارس ٢٠٢٤'),
      DashboardWorkspaceField(label: 'عدد الرحلات', value: '٣٤٢'),
      DashboardWorkspaceField(
        label: 'الملاحظات',
        value: 'ملتزم ومناسب للرحلات الصباحية',
      ),
      DashboardWorkspaceField(label: 'المرفقات', value: 'رخصة - بطاقة - عقد'),
    ],
    'vehicles' => const [
      DashboardWorkspaceField(label: 'الموديل', value: '٢٠٢٣'),
      DashboardWorkspaceField(label: 'السائق الحالي', value: 'محمد أحمد'),
      DashboardWorkspaceField(
        label: 'المسار الحالي',
        value: 'بنها - القرية الذكية',
      ),
      DashboardWorkspaceField(label: 'التأمين', value: 'ساري حتى ٢٠٢٧'),
      DashboardWorkspaceField(label: 'الرخصة', value: 'سارية'),
      DashboardWorkspaceField(label: 'الفحص الفني', value: 'مكتمل'),
    ],
    'routes' => const [
      DashboardWorkspaceField(label: 'المسافة', value: '٧٦ كم'),
      DashboardWorkspaceField(label: 'المدة', value: '٧٥ دقيقة'),
      DashboardWorkspaceField(label: 'عدد النقاط', value: '٥'),
      DashboardWorkspaceField(
        label: 'إدارة النقاط',
        value: 'إضافة - تعديل - حذف - ترتيب',
      ),
    ],
    'trips' || 'liveTrips' => const [
      DashboardWorkspaceField(label: 'المركبة', value: 'أ ب ج ٤٥٦'),
      DashboardWorkspaceField(label: 'عدد الركاب', value: '١٠ / ١٢'),
      DashboardWorkspaceField(label: 'الوقت', value: '٨:٣٠ صباحاً'),
      DashboardWorkspaceField(
        label: 'الملاحظات',
        value: 'متابعة التشغيل مطلوبة',
      ),
    ],
    'bookings' => const [
      DashboardWorkspaceField(label: 'المقعد', value: '٦'),
      DashboardWorkspaceField(label: 'المبلغ', value: '١٢٠ ج.م'),
      DashboardWorkspaceField(label: 'طريقة الدفع', value: 'تحويل بنكي'),
      DashboardWorkspaceField(label: 'المرفقات', value: 'إيصال دفع وهمي'),
    ],
    'payments' => const [
      DashboardWorkspaceField(label: 'الطريقة', value: 'تحويل بنكي'),
      DashboardWorkspaceField(label: 'التاريخ', value: 'اليوم ٩:٤٥ صباحاً'),
      DashboardWorkspaceField(label: 'الإيصال', value: 'receipt_mock_1001.jpg'),
    ],
    'tickets' => const [
      DashboardWorkspaceField(label: 'نوع الشكوى', value: 'الدفع'),
      DashboardWorkspaceField(label: 'الوصف', value: 'مشكلة في تأكيد الدفع'),
      DashboardWorkspaceField(label: 'الردود', value: '٣ ردود'),
      DashboardWorkspaceField(label: 'المرفقات', value: 'صورة محادثة وهمية'),
    ],
