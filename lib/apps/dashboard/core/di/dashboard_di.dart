import 'package:bmt_app/core/network/network_di.dart';
import 'package:bmt_app/apps/dashboard/modules/settings/auth/data/datasources/dashboard_auth_datasource.dart';
import 'package:bmt_app/apps/dashboard/modules/settings/auth/presentation/cubit/dashboard_auth_cubit.dart';
import 'package:bmt_app/apps/dashboard/modules/notifications/data/datasources/supabase_notifications_dispatch_datasource.dart';
import 'package:bmt_app/apps/dashboard/modules/notifications/data/repositories/notifications_dispatch_repository_impl.dart';
import 'package:bmt_app/apps/dashboard/modules/notifications/domain/repositories/notifications_dispatch_repository.dart';
import 'package:bmt_app/apps/dashboard/modules/notifications/domain/usecases/send_notification_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/notifications/presentation/cubit/notifications_dispatch_cubit.dart';
import 'package:bmt_app/apps/dashboard/modules/bookings/data/datasources/bookings_datasource.dart';
import 'package:bmt_app/apps/dashboard/modules/users/data/datasources/users_datasource.dart';
import 'package:bmt_app/apps/dashboard/modules/users/domain/repositories/users_repository.dart';
import 'package:bmt_app/apps/dashboard/modules/users/domain/usecases/get_current_user_role_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/users/domain/usecases/get_users_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/users/domain/usecases/update_user_role_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/users/presentation/cubit/users_cubit.dart';
import 'package:get_it/get_it.dart';
import 'package:supabase_flutter/supabase_flutter.dart';

import 'package:bmt_app/apps/dashboard/modules/bookings/data/datasources/supabase_bookings_datasource.dart';
import 'package:bmt_app/apps/dashboard/modules/bookings/data/repositories/bookings_repository_impl.dart';
import 'package:bmt_app/apps/dashboard/modules/bookings/domain/repositories/bookings_repository.dart';
import 'package:bmt_app/apps/dashboard/modules/bookings/domain/usecases/approve_booking_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/bookings/domain/usecases/assign_bookings_to_trip_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/bookings/domain/usecases/bulk_update_bookings_status_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/bookings/domain/usecases/get_operation_bookings_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/bookings/domain/usecases/reject_booking_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/bookings/domain/usecases/request_reupload_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/bookings/domain/usecases/update_booking_status_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/bookings/domain/usecases/watch_bookings_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/bookings/presentation/cubit/bookings_cubit.dart';
import 'package:bmt_app/apps/dashboard/modules/users/referrals/data/datasources/referral_datasource.dart';
import 'package:bmt_app/apps/dashboard/modules/users/referrals/data/datasources/supabase_referral_datasource.dart';
import 'package:bmt_app/apps/dashboard/modules/users/referrals/data/repositories/referral_repository_impl.dart';
import 'package:bmt_app/apps/dashboard/modules/users/referrals/domain/repositories/referral_repository.dart';
import 'package:bmt_app/apps/dashboard/modules/users/referrals/domain/usecases/referral_usecases.dart';
import 'package:bmt_app/apps/dashboard/modules/users/referrals/presentation/cubit/referral_cubit.dart';
import 'package:bmt_app/apps/dashboard/modules/analytics/dashboard_home/data/datasources/dashboard_home_datasource.dart';
import 'package:bmt_app/apps/dashboard/modules/analytics/dashboard_home/data/datasources/supabase_dashboard_home_datasource.dart';
import 'package:bmt_app/apps/dashboard/modules/analytics/dashboard_home/data/repositories/dashboard_home_repository_impl.dart';
import 'package:bmt_app/apps/dashboard/modules/analytics/dashboard_home/domain/repositories/dashboard_home_repository.dart';
import 'package:bmt_app/apps/dashboard/modules/analytics/dashboard_home/domain/usecases/get_dashboard_home_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/analytics/dashboard_home/presentation/cubit/dashboard_home_cubit.dart';
import 'package:bmt_app/apps/dashboard/modules/trips/dashboard_operations/data/repositories/dashboard_operations_repository_impl.dart';
import 'package:bmt_app/apps/dashboard/modules/trips/dashboard_operations/domain/repositories/dashboard_operations_repository.dart';
import 'package:bmt_app/apps/dashboard/modules/trips/dashboard_operations/domain/usecases/get_dashboard_workspace_usecase.dart';
...
// ── Fleet Sub-modules ────────────────────────────────────────────────
import 'package:bmt_app/apps/dashboard/modules/fleet/fleet_drivers/data/repositories/fleet_drivers_repository_impl.dart';
import 'package:bmt_app/apps/dashboard/modules/fleet/fleet_drivers/domain/repositories/fleet_drivers_repository.dart';
import 'package:bmt_app/apps/dashboard/modules/fleet/fleet_drivers/domain/usecases/fleet_drivers_usecases.dart';
import 'package:bmt_app/apps/dashboard/modules/fleet/fleet_drivers/presentation/cubit/fleet_drivers_cubit.dart';

import 'package:bmt_app/apps/dashboard/modules/fleet/fleet_vehicles/data/repositories/fleet_vehicles_repository_impl.dart';
import 'package:bmt_app/apps/dashboard/modules/fleet/fleet_vehicles/domain/repositories/fleet_vehicles_repository.dart';
import 'package:bmt_app/apps/dashboard/modules/fleet/fleet_vehicles/domain/usecases/fleet_vehicles_usecases.dart';
import 'package:bmt_app/apps/dashboard/modules/fleet/fleet_vehicles/presentation/cubit/fleet_vehicles_cubit.dart';

import 'package:bmt_app/apps/dashboard/modules/fleet/fleet_assignments/data/repositories/fleet_assignments_repository_impl.dart';
import 'package:bmt_app/apps/dashboard/modules/fleet/fleet_assignments/domain/repositories/fleet_assignments_repository.dart';
...
import 'package:bmt_app/apps/dashboard/modules/fleet/fleet_documents/data/repositories/fleet_documents_repository_impl.dart';
import 'package:bmt_app/apps/dashboard/modules/fleet/fleet_documents/domain/repositories/fleet_documents_repository.dart';
...
import 'package:bmt_app/apps/dashboard/modules/fleet/data/repositories/fleet_repository_impl.dart';
import 'package:bmt_app/apps/dashboard/modules/fleet/domain/repositories/fleet_repository.dart';
import 'package:bmt_app/apps/dashboard/modules/fleet/domain/usecases/fleet_usecases.dart';
import 'package:bmt_app/apps/dashboard/modules/fleet/overview/presentation/cubit/fleet_overview_cubit.dart';
import 'package:bmt_app/apps/dashboard/modules/trips/live_trips/data/datasources/live_trips_datasource.dart';
import 'package:bmt_app/apps/dashboard/modules/trips/live_trips/data/datasources/supabase_live_trips_datasource.dart';
import 'package:bmt_app/apps/dashboard/modules/trips/live_trips/data/repositories/live_trips_repository_impl.dart';
import 'package:bmt_app/apps/dashboard/modules/trips/live_trips/domain/repositories/live_trips_repository.dart';
import 'package:bmt_app/apps/dashboard/modules/trips/live_trips/domain/usecases/get_live_trips_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/trips/live_trips/domain/usecases/get_live_trip_details_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/trips/live_trips/domain/usecases/start_live_trip_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/trips/live_trips/domain/usecases/pause_live_trip_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/trips/live_trips/domain/usecases/resume_live_trip_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/trips/live_trips/domain/usecases/complete_live_trip_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/trips/live_trips/domain/usecases/mark_route_point_arrived_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/trips/live_trips/domain/usecases/mark_route_point_completed_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/trips/live_trips/domain/usecases/skip_route_point_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/trips/live_trips/domain/usecases/resolve_live_trip_alert_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/trips/live_trips/domain/usecases/report_live_trip_alert_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/trips/live_trips/domain/usecases/call_driver_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/trips/live_trips/domain/usecases/send_driver_message_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/trips/live_trips/domain/usecases/toggle_passenger_checkin_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/trips/live_trips/domain/usecases/watch_live_trips_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/trips/live_trips/domain/usecases/watch_vehicle_position_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/trips/live_trips/presentation/cubit/live_trips_cubit.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/data/datasources/payments_datasource.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/data/datasources/supabase_payments_datasource.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/data/repositories/payments_repository_impl.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/domain/repositories/payments_repository.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/domain/usecases/add_payment_note_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/domain/usecases/get_finance_payments_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/domain/usecases/reassign_booking_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/domain/usecases/update_payment_review_status_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/presentation/cubit/payments_cubit.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/payment_verification/data/datasources/booking_payment_verification_datasource.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/payment_verification/data/datasources/supabase_booking_payment_verification_datasource.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/payment_verification/data/repositories/booking_payment_verification_repository_impl.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/payment_verification/domain/repositories/booking_payment_verification_repository.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/payment_verification/domain/usecases/add_booking_payment_note_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/payment_verification/domain/usecases/approve_booking_payment_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/payment_verification/domain/usecases/get_booking_payment_verifications_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/payment_verification/domain/usecases/reject_booking_payment_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/payment_verification/domain/usecases/request_booking_payment_review_usecase.dart';
...
import 'package:bmt_app/apps/dashboard/modules/routes/data/datasources/routes_datasource.dart';
import 'package:bmt_app/apps/dashboard/modules/routes/data/datasources/supabase_routes_datasource.dart';
import 'package:bmt_app/apps/dashboard/modules/routes/data/repositories/routes_repository_impl.dart';
import 'package:bmt_app/apps/dashboard/modules/routes/domain/repositories/routes_repository.dart';
import 'package:bmt_app/apps/dashboard/modules/routes/domain/usecases/add_route_station_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/routes/domain/usecases/create_route_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/routes/domain/usecases/delete_route_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/routes/domain/usecases/delete_route_station_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/routes/domain/usecases/get_operation_routes_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/routes/domain/usecases/reorder_route_stations_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/routes/domain/usecases/update_route_station_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/routes/domain/usecases/update_route_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/routes/domain/usecases/search_places_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/routes/domain/usecases/get_route_geometry_usecase.dart';
...
import 'package:bmt_app/apps/dashboard/modules/payments/subscriptions/data/datasources/subscriptions_datasource.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/subscriptions/data/datasources/supabase_subscriptions_datasource.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/subscriptions/data/repositories/subscriptions_repository_impl.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/subscriptions/domain/repositories/subscriptions_repository.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/subscriptions/domain/usecases/cancel_subscription_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/subscriptions/domain/usecases/confirm_payment_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/subscriptions/domain/usecases/create_subscription_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/subscriptions/domain/usecases/get_subscription_creation_options_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/subscriptions/domain/usecases/get_subscription_details_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/subscriptions/domain/usecases/get_subscriptions_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/subscriptions/domain/usecases/mark_subscription_ride_used_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/subscriptions/domain/usecases/renew_subscription_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/subscriptions/presentation/cubit/subscriptions_cubit.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/subscriptions/plans/data/datasources/subscription_plans_datasource.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/subscriptions/plans/data/repositories/subscription_plans_repository_impl.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/subscriptions/plans/domain/repositories/subscription_plans_repository.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/subscriptions/plans/domain/usecases/subscription_plans_usecases.dart';
import 'package:bmt_app/apps/dashboard/modules/payments/subscriptions/plans/presentation/cubit/subscription_plans_cubit.dart';
import 'package:bmt_app/apps/dashboard/modules/trips/trips_di.dart';
// Mock vehicles removed
import 'package:bmt_app/apps/dashboard/modules/tickets/data/datasources/supabase_tickets_datasource.dart';
import 'package:bmt_app/apps/dashboard/modules/tickets/data/repositories/tickets_repository_impl.dart';
import 'package:bmt_app/apps/dashboard/modules/tickets/domain/repositories/tickets_repository.dart';
import 'package:bmt_app/apps/dashboard/modules/tickets/domain/usecases/close_ticket_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/tickets/domain/usecases/get_tickets_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/tickets/domain/usecases/update_ticket_status_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/tickets/domain/usecases/save_internal_note_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/tickets/domain/usecases/mark_customer_contacted_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/tickets/domain/usecases/assign_agent_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/tickets/domain/usecases/get_ticket_attachments_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/tickets/presentation/cubit/tickets_cubit.dart';
import 'package:bmt_app/apps/dashboard/modules/finance/data/repositories/finance_repository_impl.dart';
import 'package:bmt_app/apps/dashboard/modules/finance/domain/repositories/finance_repository.dart';
import 'package:bmt_app/apps/dashboard/modules/finance/domain/usecases/cancel_subscription_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/finance/domain/usecases/get_payments_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/finance/domain/usecases/get_receipt_reviews_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/finance/domain/usecases/get_refund_requests_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/finance/domain/usecases/get_revenue_metrics_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/finance/domain/usecases/get_revenue_trend_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/finance/domain/usecases/get_subscriptions_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/finance/domain/usecases/process_refund_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/finance/domain/usecases/review_receipt_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/finance/data/datasources/finance_datasource.dart';
import 'package:bmt_app/apps/dashboard/modules/finance/data/datasources/supabase_finance_datasource.dart';
import 'package:bmt_app/apps/dashboard/modules/finance/presentation/cubit/finance_cubit.dart';
import 'package:bmt_app/apps/dashboard/modules/analytics/owner_overview/data/datasources/owner_overview_datasource.dart';
import 'package:bmt_app/apps/dashboard/modules/analytics/owner_overview/data/repositories/owner_overview_repository_impl.dart';
import 'package:bmt_app/apps/dashboard/modules/analytics/owner_overview/domain/repositories/owner_overview_repository.dart';
import 'package:bmt_app/apps/dashboard/modules/analytics/owner_overview/domain/usecases/get_owner_overview_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/analytics/owner_overview/presentation/cubit/owner_overview_cubit.dart';
import 'package:bmt_app/apps/dashboard/modules/analytics/reports/data/datasources/reports_datasource.dart';
import 'package:bmt_app/apps/dashboard/modules/analytics/reports/data/datasources/supabase_reports_datasource.dart';
import 'package:bmt_app/apps/dashboard/modules/analytics/reports/data/repositories/reports_repository_impl.dart';
import 'package:bmt_app/apps/dashboard/modules/analytics/reports/domain/repositories/reports_repository.dart';
import 'package:bmt_app/apps/dashboard/modules/analytics/reports/domain/usecases/export_report_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/analytics/reports/domain/usecases/get_available_drivers_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/analytics/reports/domain/usecases/get_available_packages_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/analytics/reports/domain/usecases/get_available_routes_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/analytics/reports/domain/usecases/get_available_vehicles_usecase.dart';
import 'package:bmt_app/apps/dashboard/modules/analytics/reports/domain/usecases/get_report_data_usecase.dart';
