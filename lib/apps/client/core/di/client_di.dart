...
import 'package:bmt_app/apps/client/modules/account/onboarding/data/datasources/onboarding_local_datasource.dart';
import 'package:bmt_app/apps/client/modules/account/onboarding/data/repositories/onboarding_repository_impl.dart';
import 'package:bmt_app/apps/client/modules/account/onboarding/domain/repositories/onboarding_repository.dart';
import 'package:bmt_app/apps/client/modules/account/onboarding/domain/usecases/check_onboarding_status_usecase.dart';
import 'package:bmt_app/apps/client/modules/account/onboarding/domain/usecases/complete_onboarding_usecase.dart';
import 'package:bmt_app/apps/client/modules/account/onboarding/presentation/cubit/onboarding_cubit.dart';
import '../../../../core/security/secure_storage.dart';

import 'package:bmt_app/apps/client/modules/account/auth/data/datasources/client_auth_datasource.dart';
import 'package:bmt_app/apps/client/modules/account/auth/data/datasources/supabase_client_auth_datasource.dart';
import 'package:bmt_app/apps/client/modules/account/auth/data/repositories/client_auth_repository_impl.dart';
import 'package:bmt_app/apps/client/modules/account/auth/domain/repositories/client_auth_repository.dart';
import 'package:bmt_app/apps/client/modules/account/auth/domain/usecases/sign_in_with_email_usecase.dart';
import 'package:bmt_app/apps/client/modules/account/auth/domain/usecases/sign_up_with_email_usecase.dart';
import 'package:bmt_app/apps/client/modules/account/auth/domain/usecases/send_password_reset_email_usecase.dart';
...
import 'package:bmt_app/apps/client/modules/booking/booking/data/datasources/booking_search_datasource.dart';
import 'package:bmt_app/apps/client/modules/booking/booking/data/datasources/daily_booking_datasource.dart';
import 'package:bmt_app/apps/client/modules/booking/booking/data/datasources/supabase_booking_search_datasource.dart';
import 'package:bmt_app/apps/client/modules/booking/booking/data/datasources/supabase_daily_booking_datasource.dart';
import 'package:bmt_app/apps/client/modules/booking/booking/data/datasources/supabase_vehicle_booking_datasource.dart';
import 'package:bmt_app/apps/client/modules/booking/booking/data/datasources/vehicle_booking_datasource.dart';
import 'package:bmt_app/apps/client/modules/booking/booking/data/repositories/booking_repository_impl.dart';
import 'package:bmt_app/apps/client/modules/booking/booking/domain/repositories/booking_repository.dart';
import 'package:bmt_app/apps/client/modules/booking/booking/domain/usecases/get_available_trips_usecase.dart';
import 'package:bmt_app/apps/client/modules/booking/booking/domain/usecases/get_booking_hub_data_usecase.dart';
import 'package:bmt_app/apps/client/modules/booking/booking/domain/usecases/get_booking_routes_usecase.dart';
import 'package:bmt_app/apps/client/modules/booking/booking/domain/usecases/get_daily_booking_data_usecase.dart';
import 'package:bmt_app/apps/client/modules/booking/booking/domain/usecases/get_map_pins_usecase.dart';
import 'package:bmt_app/apps/client/modules/booking/booking/domain/usecases/get_popular_routes_usecase.dart';
import 'package:bmt_app/apps/client/modules/booking/booking/domain/usecases/get_search_options_usecase.dart';
import 'package:bmt_app/apps/client/modules/booking/booking/domain/usecases/get_vehicle_details_usecase.dart';
import 'package:bmt_app/apps/client/modules/booking/booking/domain/usecases/get_vehicles_usecase.dart';
import 'package:bmt_app/apps/client/modules/booking/booking/domain/usecases/sort_vehicles_usecase.dart';
import 'package:bmt_app/apps/client/modules/booking/booking/presentation/cubit/booking_cubit.dart';
import 'package:bmt_app/apps/client/modules/operations/communication/data/datasources/supabase_communication_datasource.dart';
import 'package:bmt_app/apps/client/modules/operations/communication/data/repositories/communication_repository_impl.dart';
import 'package:bmt_app/apps/client/modules/operations/communication/domain/repositories/communication_repository.dart';
import 'package:bmt_app/apps/client/modules/operations/communication/domain/usecases/add_conversation_message_usecase.dart';
import 'package:bmt_app/apps/client/modules/operations/communication/domain/usecases/get_conversations_usecase.dart';
import 'package:bmt_app/apps/client/modules/operations/communication/domain/usecases/send_conversation_message_usecase.dart';
import 'package:bmt_app/apps/client/modules/operations/communication/presentation/cubit/communication_cubit.dart';
import 'package:bmt_app/apps/client/modules/home/home/data/datasources/home_datasource.dart';
import 'package:bmt_app/apps/client/modules/home/home/data/datasources/supabase_home_datasource.dart';
import 'package:bmt_app/apps/client/modules/home/home/data/repositories/home_repository_impl.dart';
import 'package:bmt_app/apps/client/modules/home/home/domain/repositories/home_repository.dart';
import 'package:bmt_app/apps/client/modules/home/home/domain/usecases/get_home_data_usecase.dart';
import 'package:bmt_app/apps/client/modules/home/home/presentation/cubit/home_cubit.dart';
import 'package:bmt_app/apps/client/modules/rewards/loyalty/data/datasources/loyalty_datasource.dart';
import 'package:bmt_app/apps/client/modules/rewards/loyalty/data/datasources/supabase_loyalty_datasource.dart';
import 'package:bmt_app/apps/client/modules/rewards/loyalty/data/repositories/loyalty_repository_impl.dart';
import 'package:bmt_app/apps/client/modules/rewards/loyalty/domain/repositories/loyalty_repository.dart';
import 'package:bmt_app/apps/client/modules/rewards/loyalty/domain/usecases/get_loyalty_data_usecase.dart';
import 'package:bmt_app/apps/client/modules/rewards/loyalty/domain/usecases/redeem_loyalty_reward_usecase.dart';
import 'package:bmt_app/apps/client/modules/rewards/loyalty/presentation/cubit/loyalty_cubit.dart';
import 'package:bmt_app/apps/client/modules/notifications/notifications/data/datasources/supabase_notifications_datasource.dart';
import 'package:bmt_app/apps/client/modules/notifications/notifications/data/repositories/notifications_repository_impl.dart';
import 'package:bmt_app/apps/client/modules/notifications/notifications/domain/repositories/notifications_repository.dart';
import 'package:bmt_app/apps/client/modules/notifications/notifications/domain/usecases/get_notifications_usecase.dart';
import 'package:bmt_app/apps/client/modules/notifications/notifications/domain/usecases/watch_notifications_usecase.dart';
import 'package:bmt_app/apps/client/modules/notifications/notifications/domain/usecases/mark_as_read_usecase.dart';
import 'package:bmt_app/apps/client/modules/notifications/notifications/domain/usecases/mark_all_as_read_usecase.dart';
import 'package:bmt_app/apps/client/modules/notifications/notifications/domain/usecases/watch_unread_count_usecase.dart';
import 'package:bmt_app/apps/client/modules/notifications/notifications/presentation/cubit/notifications_cubit.dart';
import 'package:bmt_app/apps/client/modules/notifications/notifications/presentation/cubit/notification_badge_cubit.dart';
import 'package:bmt_app/apps/client/modules/payments/payments/data/datasources/payment_datasource.dart';
import 'package:bmt_app/apps/client/modules/payments/payments/data/datasources/supabase_payment_datasource.dart';
import 'package:bmt_app/apps/client/modules/payments/payments/data/repositories/payment_repository_impl.dart';
import 'package:bmt_app/apps/client/modules/payments/payments/domain/repositories/payment_repository.dart';
import 'package:bmt_app/apps/client/modules/payments/payments/domain/usecases/apply_promo_code_usecase.dart';
import 'package:bmt_app/apps/client/modules/payments/payments/domain/usecases/create_card_payment_session_usecase.dart';
import 'package:bmt_app/apps/client/modules/payments/payments/domain/usecases/get_payment_methods_usecase.dart';
import 'package:bmt_app/apps/client/modules/payments/payments/domain/usecases/upload_payment_receipt_usecase.dart';
import 'package:bmt_app/apps/client/modules/payments/payments/presentation/cubit/payment_cubit.dart';
import 'package:bmt_app/apps/client/modules/services/packages/data/datasources/packages_datasource.dart';
import 'package:bmt_app/apps/client/modules/services/packages/data/datasources/supabase_packages_datasource.dart';
import 'package:bmt_app/apps/client/modules/services/packages/data/repositories/packages_repository_impl.dart';
import 'package:bmt_app/apps/client/modules/services/packages/domain/repositories/packages_repository.dart';
import 'package:bmt_app/apps/client/modules/services/packages/domain/usecases/calculate_package_pricing_usecase.dart';
import 'package:bmt_app/apps/client/modules/services/packages/domain/usecases/create_subscription_usecase.dart';
import 'package:bmt_app/apps/client/modules/services/packages/domain/usecases/filter_packages_usecase.dart';
import 'package:bmt_app/apps/client/modules/services/packages/domain/usecases/get_package_selection_data_usecase.dart';
import 'package:bmt_app/apps/client/modules/services/packages/presentation/cubit/packages_cubit.dart';
import 'package:bmt_app/apps/client/modules/account/profile/data/datasources/profile_datasource.dart';
import 'package:bmt_app/apps/client/modules/account/profile/data/datasources/supabase_profile_datasource.dart';
import 'package:bmt_app/apps/client/modules/account/profile/data/repositories/profile_repository_impl.dart';
import 'package:bmt_app/apps/client/modules/account/profile/domain/repositories/profile_repository.dart';
import 'package:bmt_app/apps/client/modules/account/profile/domain/usecases/get_profile_data_usecase.dart';
import 'package:bmt_app/apps/client/modules/account/profile/presentation/cubit/profile_cubit.dart';
import 'package:bmt_app/apps/client/modules/services/routes/data/datasources/supabase_routes_hub_datasource.dart';
import 'package:bmt_app/apps/client/modules/services/routes/data/repositories/routes_hub_repository_impl.dart';
import 'package:bmt_app/apps/client/modules/services/routes/domain/repositories/routes_hub_repository.dart';
import 'package:bmt_app/apps/client/modules/services/routes/domain/usecases/get_routes_hub_data_usecase.dart';
import 'package:bmt_app/apps/client/modules/services/routes/presentation/cubit/routes_hub_cubit.dart';
import 'package:bmt_app/apps/client/modules/rewards/referrals/data/datasources/supabase_referral_rewards_datasource.dart';
import 'package:bmt_app/apps/client/modules/rewards/referrals/data/repositories/referral_rewards_repository_impl.dart';
import 'package:bmt_app/apps/client/modules/rewards/referrals/domain/repositories/referral_rewards_repository.dart';
import 'package:bmt_app/apps/client/modules/rewards/referrals/domain/usecases/get_referral_rewards_data_usecase.dart';
import 'package:bmt_app/apps/client/modules/rewards/referrals/domain/usecases/update_referral_rewards_usecase.dart';
import 'package:bmt_app/apps/client/modules/rewards/referrals/presentation/cubit/referral_rewards_cubit.dart';
import 'package:bmt_app/apps/client/modules/booking/seat_selection/data/datasources/seat_selection_datasource.dart';
import 'package:bmt_app/apps/client/modules/booking/seat_selection/data/datasources/supabase_seat_selection_datasource.dart';
import 'package:bmt_app/apps/client/modules/booking/seat_selection/data/repositories/seat_selection_repository_impl.dart';
import 'package:bmt_app/apps/client/modules/booking/seat_selection/domain/repositories/seat_selection_repository.dart';
import 'package:bmt_app/apps/client/modules/booking/seat_selection/domain/usecases/get_seat_selection_data_usecase.dart';
import 'package:bmt_app/apps/client/modules/booking/seat_selection/domain/usecases/select_seat_usecase.dart';
import 'package:bmt_app/apps/client/modules/booking/seat_selection/domain/usecases/book_trip_seat_usecase.dart';
import 'package:bmt_app/apps/client/modules/booking/seat_selection/domain/usecases/lock_trip_seat_usecase.dart';
...
import 'package:bmt_app/apps/client/modules/booking/seat_release/data/datasources/supabase_seat_release_datasource.dart';
import 'package:bmt_app/apps/client/modules/booking/seat_release/data/repositories/seat_release_repository_impl.dart';
import 'package:bmt_app/apps/client/modules/booking/seat_release/domain/repositories/seat_release_repository.dart';
import 'package:bmt_app/apps/client/modules/booking/seat_release/domain/usecases/get_seat_release_data_usecase.dart';
import 'package:bmt_app/apps/client/modules/booking/seat_release/presentation/cubit/seat_release_cubit.dart';
import 'package:bmt_app/apps/client/modules/account/settings/data/datasources/supabase_settings_datasource.dart';
import 'package:bmt_app/apps/client/modules/account/settings/data/repositories/settings_repository_impl.dart';
import 'package:bmt_app/apps/client/modules/account/settings/domain/repositories/settings_repository.dart';
import 'package:bmt_app/apps/client/modules/account/settings/domain/usecases/get_settings_data_usecase.dart';
import 'package:bmt_app/apps/client/modules/account/settings/presentation/cubit/settings_cubit.dart';
import 'package:bmt_app/apps/client/modules/operations/support/data/datasources/supabase_support_datasource.dart';
import 'package:bmt_app/apps/client/modules/operations/support/data/repositories/support_repository_impl.dart';
import 'package:bmt_app/apps/client/modules/operations/support/domain/repositories/support_repository.dart';
import 'package:bmt_app/apps/client/modules/operations/support/domain/usecases/create_support_ticket_usecase.dart';
import 'package:bmt_app/apps/client/modules/operations/support/domain/usecases/get_support_workspace_usecase.dart';
import 'package:bmt_app/apps/client/modules/operations/support/domain/usecases/get_my_support_tickets_usecase.dart';
import 'package:bmt_app/apps/client/modules/operations/support/domain/usecases/get_ticket_details_usecase.dart';

import 'package:bmt_app/apps/client/modules/operations/support/presentation/cubit/support_cubit.dart';
import 'package:bmt_app/apps/client/modules/trips/trips/data/datasources/supabase_trips_datasource.dart';
import 'package:bmt_app/apps/client/modules/trips/trips/data/datasources/trips_datasource.dart';
import 'package:bmt_app/apps/client/modules/trips/trips/data/repositories/trips_repository_impl.dart';
import 'package:bmt_app/apps/client/modules/trips/trips/domain/repositories/trips_repository.dart';
import 'package:bmt_app/apps/client/modules/trips/trips/domain/usecases/get_trip_details_usecase.dart';
import 'package:bmt_app/apps/client/modules/trips/trips/domain/usecases/get_trips_usecase.dart';
import 'package:bmt_app/apps/client/modules/trips/trips/presentation/cubit/trips_cubit.dart';
import 'package:bmt_app/apps/client/modules/tracking/tracking/data/datasources/supabase_tracking_datasource.dart';
import 'package:bmt_app/apps/client/modules/tracking/tracking/data/repositories/tracking_repository_impl.dart';
import 'package:bmt_app/apps/client/modules/tracking/tracking/domain/repositories/tracking_repository.dart';
import 'package:bmt_app/apps/client/modules/tracking/tracking/domain/usecases/get_tracking_title_usecase.dart';
import 'package:bmt_app/apps/client/modules/tracking/tracking/domain/usecases/get_tracking_trip_usecase.dart';
import 'package:bmt_app/apps/client/modules/tracking/tracking/domain/usecases/watch_vehicle_position_usecase.dart';
