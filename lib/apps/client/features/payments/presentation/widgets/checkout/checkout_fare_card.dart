    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _FareRow(label: 'Ticket fare', value: data.baseFare),
          if (data.serviceFee > 0)
            _FareRow(label: 'Service fee', value: data.serviceFee),
          if (data.tax > 0) _FareRow(label: 'Tax', value: data.tax),
          if (promoDiscount > 0)
            _FareRow(
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Flexible(
            child: Text(
              value < 0 ? '− ${value.abs()} EGP' : '$value EGP',
