...
class HomePackagesSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final count = previewCount.clamp(1, plans.length);
    final visiblePlans = plans.take(count).toList();
    ...
    return Column(
      ...
      children: [
        ...
        if (showActivePackage) ...[
          _ActivePackageCard(scheme: scheme, onTap: onOpenSubscription),
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            gradient: LinearGradient(
              colors: [scheme.surface, scheme.primary.withAlpha(15)],
