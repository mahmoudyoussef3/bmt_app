// Money formatting for Home. Supabase stores amounts as bare numerics, and a
// missing or zero amount means "not priced yet" — which the UI says out loud
// rather than rendering as a fake `EGP 0`.
