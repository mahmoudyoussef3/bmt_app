...
///
/// An earlier build pointed [Image.network] at an SVG URL, which Flutter cannot
/// decode — so the button rendered a broken-image icon. This paints the
/// four-color glyph directly so it works offline and in tests.
///
/// It also has to be painted rather than themed: Google's brand guidelines
/// require the mark to keep its own colours on a sign-in button, so it cannot
/// go through the [IconTheme] every other glyph in this app obeys.
