    ...
    return BlocProvider<LiveLocationCubit>(
      ...
      child: Scaffold(
        body: CustomScrollView(
          slivers: [
            const CaptainSliverHeader(title: 'إرسال الموقع'),
            BlocConsumer<LiveLocationCubit, LiveLocationState>(
                              ...
                              if (lastSentAt != null) ...[
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: scheme.primaryContainer.withAlpha(
                                      100,
                                    ),
