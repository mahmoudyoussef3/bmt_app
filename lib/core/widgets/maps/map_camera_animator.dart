...
/// entrance fits, bound changes and vehicle-follow updates all glide. Only
/// one animation runs at a time — starting a new one retargets the previous
/// mid-flight, so a fix arriving mid-follow never causes a backwards jump.
